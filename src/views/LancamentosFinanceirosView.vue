<template>
    <div>
        <div class="mb-5">
        <h1 class="text-h6 font-weight-bold">Lançamentos Financeiros</h1>
        ...
        <v-row>
            <v-col cols="12" lg="15">
                <ChartCard
                    title="QUANTIDADE MENSAL DE LANÇAMENTOS FINANCEIROS."
                    :subtitle="`${monthInicio}-${yearA} X ${monthAtual}-${yearB}`"
                    :loading="!comparativeData"
                    :height="380"
                    >
                    <BaseChart :option="lineComparationOptionMxA" :width="360" />
                </ChartCard>
        ...
        <v-row>
            <v-col cols="12" lg="15">
                <ChartCard
                    title="MÉDIA ANUAL DE LANÇAMENTOS FINANCEIROS MANUAIS E AUTOMÁTICOS"
                    :subtitle="`2013 X ${yearB}`"
                    :loading="!comparativeData"
                    :height="380"
                    >
                    <BaseChart :option="lineVariationOptionMxA" :width="360" />
                </ChartCard>
        ...
        <v-row>
            <v-col cols="12" lg="15">
                <ChartCard
                    title="QUANTIDADE MENSAL DE LANÇAMENTOS FINANCEIROS MANUAIS"
                    :subtitle="`${monthInicio}-${yearA} X ${monthAtual}-${yearB}`"
                    :loading="!comparativeData"
                    :height="380"
                    >
                    <BaseChart :option="lineVariationOptionM" :width="360" />
                </ChartCard>
        ...
        <v-row>
            <v-col cols="12" lg="15">
                <ChartCard
                    title="MÉDIA ANUAL DE LANÇAMENTOS FINANCEIROS"
                    :subtitle="`2013 X ${yearB}`"
                    :loading="!comparativeData"
                    :height="380"
                    >
                    <BaseChart :option="lineVariationOptionMEANU" :width="360" />
                </ChartCard>
...
const lineComparationOptionMxA = computed(() => ({
  legend: { data: ['Manuais', 'Automatizados'], position: 'top' },
  xAxis: {
    type: 'category',
    data: meses.value,
...
const lineVariationOptionMxA = computed(() => ({
  legend: { data: ['Manuais', 'Automatizados'], position: 'top' },
  xAxis: {
    type: 'category',
    data: yearsNew.value,
  ...
  series: [
      ...
      },
      {
        name: 'Automatizados',
        type: 'line',
        data: preencherAnosFaltantes(seriesData.value || [], yearsNew.value, 7000),
        itemStyle: { color: PAG_CHART_COLORS[1] },
            label: {
            show: true,
            position: 'top',
...
const lineVariationOptionM = computed(() => ({
  xAxis: {
    type: 'category',
    data: meses.value,
    axisLabel: { interval: 0 },
...
const lineVariationOptionMEANU = computed(() => ({
  xAxis: {
    type: 'category',
    data: yearsNew.value,
    axisLabel: { interval: 0 },
